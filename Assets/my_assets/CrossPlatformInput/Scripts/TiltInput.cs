...
namespace UnityStandardAssets.CrossPlatformInput
{
    ...
    public class TiltInput : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            CrossPlatformInputManager.SetVirtualMousePositionX(Input.acceleration.x);
            CrossPlatformInputManager.SetVirtualMousePositionY(Input.acceleration.y);
            CrossPlatformInputManager.SetVirtualMousePositionZ(Input.acceleration.z);
        }
